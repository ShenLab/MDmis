...
def main():
    ...
    cg2all_script = "/home/az2798/MDmis_revisions/MDmis/code/CALVADOS_simulations/run_cg2all.sh" #should be in same folder
    getcontacts_script = "/home/az2798/MDmis_revisions/MDmis/code/CALVADOS_simulations/run_GetContacts.sh"
