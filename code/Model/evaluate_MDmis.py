...
def main():
    ...
    for fold in range(1,6):
        ...
        val_feature_table = pd.read_csv(
            os.path.join(data_dir, "clinical_train_val_intcutoff_0",
    ...
    if not os.path.exists(os.path.join(results_dir, "Clinical_ROCs", f"{interaction_cutoff}")):
        os.makedirs(os.path.join(results_dir, "Clinical_ROCs", f"{interaction_cutoff}"))
    ...
    plot_average_roc(IDRs_table,
                     ...
                     os.path.join(results_dir, "Clinical_ROCs", f"{interaction_cutoff}",
