...
def create_feature_table(df_table, res_data, pair_data, aa_res_matrix,
    ...
    window_size : int
        Number of residues to compute residue features for on either side of the mutation site
    
    interaction_cutoff : float
        The proportion of the trajectory a non-bonded interaction must appear in to be considered a true
        "interaction" 
