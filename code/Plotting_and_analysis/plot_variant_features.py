...
def main():
    ...
    ## Added some polyX and polyXY statistical analysis
    contingency_table = pd.crosstab(IDRs_table_with_composition['Length Category'],
                                         IDRs_table_with_composition["Poly_X"])
                
    print(contingency_table)
    chi2, p, dof, _ = ss.chi2_contingency(contingency_table)

    print(chi2, p, "Poly X Significance")

    contingency_table = pd.crosstab(IDRs_table_with_composition['Length Category'],
                                         IDRs_table_with_composition["Poly_XY"])
    ...
    ## Added analysis for Amino-Acid composition and "complexity"

    
    # plot_ridgeplot(
    #     data=IDRs_table_with_composition,
    #     group_col='Length Category',
    #     value_col="Global Composition_G",
    #     results_dir=results_dir,
    #     xlabel = "Proportion of G",
    #     plot_filename="Proportion_G_Length.png", palette = length_palette,label_placement = "right",
    #     xlim =(-0.1, 1),
    ...
    #     data=IDRs_table_with_composition,
    #     group_col='Length Category',
    #     value_col="Global Composition_E",
    #     results_dir=results_dir,
    #     xlabel = "Proportion of E",
    #     plot_filename="Proportion_E_Length.png", palette = length_palette,label_placement = "right",
    #     xlim =(-0.1, 0.8),
    #     bar_height = 0.05, xlim_buffer = 1.025
    # )
    # plt.clf()
