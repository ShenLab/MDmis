...
def main():
    ...
    if args.mut_type == "phr":
        variants_to_simulate = IDR_MD_features[IDR_MD_features["RMSF Category"] == "Pathogenic - High RMSF"].head(50)
    
    elif args.mut_type == "plr":
        variants_to_simulate = IDR_MD_features[IDR_MD_features["RMSF Category"] == "Pathogenic - Low RMSF"].head(50)
    
    else:
        variants_to_simulate = IDR_MD_features[IDR_MD_features["RMSF Category"] == "Benign"].head(50)
    ...
    residues_file = "/share/vault/Users/az2798/residues.csv"
    # Step 2: run CALVADOS for processed sequences
    for modified_sequences in processed_sequences[args.set_mutations-1:args.set_mutations+10]:
